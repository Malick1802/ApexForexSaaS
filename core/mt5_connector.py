# =============================================================================
# MT5 Connector - Centralized Linux/Wine Bridge
# =============================================================================
"""
Centralized MetaTrader 5 connection manager that handles the Linux/Wine bridge
using the mt5linux library. Supports 127.0.0.1:18812 connectivity.
"""
...
class MT5Connector:
    """
    Singleton connector for MT5 via mt5linux bridge.
    ...
    def shutdown(self):
        """Gracefully release the bridge connection."""
        if self._connection:
            try:
